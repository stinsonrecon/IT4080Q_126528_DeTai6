        ...
        <div class="w-full justify-around items-center pt-8 lg:pl-7">
            <div class="flex justify-between w-full">
                ...
                <div class="w-1/2 px-10">
                    <img class="w-full h-full object-contain" src="{{ asset('storage/product').'/'.$product->linkImg}}" alt="">
                </div>
                ...
                <div class="w-1/2 px-10">
                    ...
                    <div class="flex-col flex-wrap">
                        ...
                        <button class="py-2 px-5 mt-5 flex items-center justify-around rounded-3xl  bg-green-primary border-2 border-green-primary text-white hover:bg-white hover:text-green-primary" type="submit">
