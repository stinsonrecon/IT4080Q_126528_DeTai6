...
<div class="flex flex-row-reverse">
        <div class="m-6"><a href="{{route('product.create')}}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
        Thêm
</a></div>
</div>
                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <div class="flex items-center">
                                            ...
                                            <img style="width: 150px;height: 100px;"  src="{{ asset('storage/product').'/'.$product->linkImg}}"/>
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        ...
                                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            <a href="{{route('product.delete',['id'=>$product->id])}}" onclick="return myFunction();"   href="" >
