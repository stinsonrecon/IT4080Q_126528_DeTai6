...
@include('back-end.components.content-header',['name'=>'Bank','key'=>' | Add'])
<!-- component -->
<div class="overflow-x-auto flex flex-col">
    
   <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" method="POST" action="{{route('bank.store')}}" >
   @csrf
    <div class="mb-4">
