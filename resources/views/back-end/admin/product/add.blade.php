...
@include('back-end.components.content-header',['name'=>'Sản phẩm','key'=>' | Thêm'])
<!-- component -->
<div class="overflow-x-auto flex flex-col">
    
   <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" method="POST" action="{{route('product.store')}}" enctype="multipart/form-data" >
   @csrf
    <div class="mb-4">
    ...
    <div class="mb-6">
      ...
      <input value="{{old('pricePromo')}}" name="pricePromo" class="@error('pricePromo') is-invalid @enderror shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"  type="text" placeholder="Nhập giá khuyến mãi">
    ...
    <div class="mb-6">
      ...
      <textarea  id="editor1" class="@error('description') is-invalid @enderror w-full px-3 py-2 text-gray-700 border rounded-lg focus:outline-none" rows="6" name="description">{{ old('description') }}</textarea>
    ...
    <div class="mb-6">
        ...
        <div class="flex @error('status') is-invalid @enderror">
            ...
            <div class="flex items-center mb-2">
                <input  @if(!old('status')) checked @endif type="radio" value="0" id="radio-example-2" name="status" class="h-4 w-4 text-gray-700 px-3 py-3 border rounded mr-2">
