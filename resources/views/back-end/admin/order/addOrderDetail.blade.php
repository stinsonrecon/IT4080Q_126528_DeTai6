...
@include('back-end.components.content-header',['name'=>'Đơn hàng chi tiết','key'=>' | Thêm'])
<!-- component -->
<div class="overflow-x-auto flex flex-col">
    
   <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" method="POST" action="{{route('orderDetail.create')}}" enctype="multipart/form-data" >
   @csrf
    <div class="mb-4">
